...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './prayer-request-form.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRAYERREQUESTFORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRAYERREQUESTFORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRAYERREQUESTFORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRAYERREQUESTFORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRAYERREQUESTFORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRAYERREQUESTFORM actions', async () => {
      const arg = 42666;
