...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACTREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACTREQUEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONTACTREQUEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTACTREQUEST actions', async () => {
      const arg = 42666;
